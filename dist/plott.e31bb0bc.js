...
},{}],"src/PlotterArea.js":[function(require,module,exports) {
"use strict";
...
var PlotterArea = /*#__PURE__*/function () {
  function PlotterArea(serial) {
    _classCallCheck(this, PlotterArea);

    this.serial = serial;
    this.waitSetting();
  }

  _createClass(PlotterArea, [{
    key: "waitSetting",
    value: function waitSetting() {
      ...
      var settingsCallback = function settingsCallback(line) {
        settingsKeys.forEach(function (settingsKey) {
          var reg = new RegExp("^$".concat(settings[settingsKey], "=(d*.?d*)"), 'ig');
...
var _default = PlotterArea;
exports.default = _default;
},{}],"src/Serial.js":[function(require,module,exports) {
"use strict";
...
var Serial = /*#__PURE__*/function () {
  ...
  _createClass(Serial, [{
    key: "init",
    value: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(baudRate) {
        var bufferSize,
            decoder,
            encoder,
            _args = arguments;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                bufferSize = _args.length > 1 && _args[1] !== undefined ? _args[1] : 2048;
    ...
    value: function write(data) {
      if (!this.port) {
        console.warn("Cannot write \"".concat(data, "\". Port not open"));
        return;
      }
    ...
    value: function dequeue() {
      ...
      if (this.port && this.queue.length > 0) {
        ...
        this.sending = true;
        this.writer.write(data).then(function () {
          _this.sending = false;
        });
      }
    }
    ...
    value: function listen() {
      ...
      var whileRead = /*#__PURE__*/function () {
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  _yield$_this2$reader$ = _context2.sent;
                ...
                case 8:
                  ...
                  value.split('\r\n').forEach(function (line) {
                    ...
                    if (line && line.length > 0) {
                      _this2.onMessageCallbacks.forEach(function (callback) {
      ...
      var whileReadable = function whileReadable() {
        if (_this2.port.readable) {
          if (whileRead()) {
            return requestAnimationFrame(whileReadable);
          }

          _this2.reader.releaseLock();
        }
      };
    ...
    value: function offMessage(callback) {
      var index = this.onMessageCallbacks.indexOf(callback);
...
var _default = Serial;
exports.default = _default;
},{}],"src/Plotter.js":[function(require,module,exports) {
"use strict";
...
var _PlotterArea = _interopRequireDefault(require("./PlotterArea"));
...
var Plotter = /*#__PURE__*/function () {
  function Plotter(settings) {
    ...
    this.serial = new _Serial.default();
    this.plotterArea = new _PlotterArea.default(this.serial);
  ...
  _createClass(Plotter, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.serial.init(115200);
    ...
    value: function penUp() {
      if (this.penStatus !== PEN_UP) {
        this.penStatus = PEN_UP;
        this.serial.write("M3 S".concat(this.settings.Z_UP));
      }
    }
  }, {
    key: "penDown",
    value: function penDown() {
      if (this.penStatus !== PEN_DOWN) {
        ...
        this.serial.write("M3 S".concat(this.settings.Z_DOWN));
      }
    }
  }, {
    key: "moveTo",
    value: function moveTo(x, y) {
      if (this.penStatus !== PEN_UP) this.penUp();
      this.serial.write("X".concat(x, " Y").concat(y));
      this.penUp();
    }
  }, {
    key: "lineTo",
    value: function lineTo(x, y) {
      var velocity = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1000;
      if (this.penStatus !== PEN_DOWN) this.penDown();
      this.serial.write("G1 X".concat(x, " Y").concat(y, " F").concat(velocity));
    }
  }]);
...
var _default = Plotter;
exports.default = _default;
},{"./PlotterArea":"src/PlotterArea.js","./Serial":"src/Serial.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("regenerator-runtime/runtime");

var _Plotter = _interopRequireDefault(require("./src/Plotter"));
...
var plotter = new _Plotter.default();
var initted = false;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            document.getElementById('penup').addEventListener('click', function () {
              plotter.penUp();
            });
            document.getElementById('pendown').addEventListener('click', function () {
              plotter.penDown();
            });
...
function draw(plotter) {
  ...
  var lines = new Urpflanze.Line({
    repetitions: [60, 1],
    sideLength: function sideLength() {
      return 50;
    },
    // Add a function for dynamic generation
    distance: [1, 0],
    vertexCallback: function vertexCallback(vertex, vertexRepetition, propArguments) {
      var y = propArguments.context.noise('seed', vertexRepetition.offset * 4, propArguments.repetition.row.offset * 3, propArguments.time / 1000);
      vertex[1] += y * 10;
    }
  });
  scene.add(lines); // Subdivide lines for add points

  lines.subdivide(6);

  var _calculateRect = calculateRect(scene),
      minX = _calculateRect.minX,
      maxX = _calculateRect.maxX,
      minY = _calculateRect.minY,
      maxY = _calculateRect.maxY;
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./src/Plotter":"src/Plotter.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/plott.e31bb0bc.js.map